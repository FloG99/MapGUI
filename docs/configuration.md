...
| `plugins/MapGUI/cache/media/` | clips downloaded through `MediaService`, named by the hash of the url they were asked for. Safe to delete; they come back when asked for |
