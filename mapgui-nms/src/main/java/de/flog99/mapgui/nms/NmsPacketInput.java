        ...
        private boolean taken(Object message) {
            try {
                ...
                if (message instanceof ServerboundUseItemPacket
                        || message instanceof ServerboundUseItemOnPacket
                        || message instanceof ServerboundInteractPacket) {
                    // Air, block and entity all count - one route in, whatever the player is aiming at.
                    return rightClick();
                }
